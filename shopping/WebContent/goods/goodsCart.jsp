			...
			<c:forEach items="${lists }" var="dto">
				<tr>
					<td colspan="4"><input type="checkbox"
						value="${dto.productDTO.prodNum}" name="prodCk"
						onchange="prodChk();" checked /> <input type="hidden"
						name="cartPrice"
				...
				<tr>
					...
					<td align="center"><a
						href="javascript:checkQty('${dto.productDTO.prodNum}','${dto.productDTO.prodPrice }','${dto.cartDTO.cartQty }')">-</a>
						&nbsp;&nbsp; ${dto.cartDTO.cartQty }&nbsp;&nbsp; <a
						href="goodsCartAdd.gd?prodNum=${dto.productDTO.prodNum}&qty=1&&prodPrice=${dto.productDTO.prodPrice }">+</a>
					</td>
					<td align="right"><fmt:formatNumber
							value="${dto.productDTO.prodPrice }" type="currency" />원</td>
					<td align="right"><fmt:formatNumber
							value="${dto.cartDTO.cartPrice }" type="currency" />원</td>
					<td align="right"><fmt:formatNumber
							value="${dto.productDTO.prodDelFee }" type="currency" />원</td>
					<td align="right"><fmt:formatNumber
							value="${dto.cartDTO.cartPrice + dto.productDTO.prodDelFee}"
							type="currency" />원</td>
				</tr>
				...
				<c:set var="price"
					value="${dto.cartDTO.cartPrice + dto.productDTO.prodDelFee + price }" />
			</c:forEach>
			<tr>
				<td colspan="4" valign="top">전체 합계</td>
				<td colspan="2" align="left">상품 수 :<br /> 총합계 :
				</td>
				<td colspan="2" align="right"><span id="prodCnt">${cnt }</span>개<br />
					<span id="totalPrice"> ${price }</span>원</td>
			</tr>
